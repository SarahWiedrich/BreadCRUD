...
breadSchema.methods.getBakedBy = function() {
  return `This ${this.name} was baked with love by ${this.baker.name} who has been with us since ${this.baker.startDate.getFullYear()}.`
}
breadSchema.statics.getBakedBy = function(name) {
